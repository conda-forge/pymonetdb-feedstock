...
All platforms: [![Circle CI](https://circleci.com/gh/conda-forge/pymonetdb-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/pymonetdb-feedstock)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/pymonetdb/badges/version.svg)](https://anaconda.org/conda-forge/pymonetdb)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/pymonetdb/badges/downloads.svg)](https://anaconda.org/conda-forge/pymonetdb)
...
Once the `conda-forge` channel has been enabled, `pymonetdb` can be installed with:

```
conda install pymonetdb
```

It is possible to list all of the versions of `pymonetdb` available on your platform with:
